...
**Student demo (text + math):** https://vidarsveen.github.io/lt_expr/demo-full.webm — complete L'Hôpital solution with text explanation blocks and math formula blocks
